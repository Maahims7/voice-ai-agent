"""
intent.py - Intent Classification Module (IMPROVED)
----------------------------------------------------
...
IMPROVEMENTS:
  ...
  - Support for compound commands (bonus feature)
...
def _classify_with_ollama(text: str) -> dict:
    ...
    try:
        ...
        try:
            ...
            return _unknown_result("Ollama timeout", "ollama")
...
def _classify_with_keywords(text: str) -> dict:
    ...
    IMPROVED: More comprehensive keyword lists.
    """
    ...
    code_keywords = [
        ...
        "generate a", "make a function", "create a function", "code me",
        "write me", "build a", "develop a", "create an app",
    ]
    ...
    file_keywords = [
        ...
        "create a new file", "touch file", "create folder", "new directory",
    ]
    ...
    summary_keywords = [
        ...
        "give me a summary", "sum up", "compress",
    ]
...
def _extract_filename(text: str) -> str | None:
    ...
    patterns = [
        ...
        r'([\w\-]+\.(?:py|js|ts|java|cpp|go|rs|sh|txt|md|html|css|sql|rb|php))',
    ]
